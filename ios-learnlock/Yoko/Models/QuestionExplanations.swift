...
enum QuestionExplanations {
    static let byTemplate: [String: String] = [
        ...
        "Fractions": "The bottom number is all the parts. The top is how many are shaded.",
        ...
        "Grammar Sorting": "If you can put 'a' or 'the' in front of it, it's a noun. If you can do it, it's a verb.",
        ...
        "Category Match": "Ask 'what kind of thing is this?' The answer tells you where it belongs.",
    ...
    static func text(for templateType: String) -> String {
        byTemplate[templateType] ?? "Take your time and think through each step."
    }
}
