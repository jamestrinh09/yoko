    ...
    private var splitBackground: some View {
        VStack(spacing: 0) {
            ZStack(alignment: .bottom) {
                AsyncImage(url: URL(string: "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/UnlockScreen.png")) { phase in
    ...
    private var mascotURL: String {
        if showSummary {
            return wrongCount > lesson.questions.count / 2
                ? "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/ProudGIF.gif"
                : "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/ExcitedGIF.gif"
        }
        if lastAnswerWasWrong {
            return "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/SadGIF.gif"
        }
        if index == lesson.questions.count - 1 {
            return "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/DeterminedGIF.gif"
        }
        if index == 1 {
            return "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/ThinkingGIF.gif"
        }
        return "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/HappyGIF.gif"
    }
