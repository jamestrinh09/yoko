...
struct OnboardingView: View {
    ...
    private func Step1() -> some View {
        VStack(spacing: 0) {
            ...
            MascotGIF(url: mascotGIF(.happy), size: min(164, UIScreen.main.bounds.width * 0.6))
                .padding(.top, 20)
        }
        .frame(maxWidth: .infinity)
        .padding(.top, 100)
    ...
    private func Step11() -> some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            RoundedImageCard(url: "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock/ability%20to%20focus%20and%20recall.png") {
...
struct DemoQuestionScreen: View {
    ...
    private var mascotURL: String {
        let base = "https://pyikafpvphzqdadjvktz.supabase.co/storage/v1/object/public/LearnLock"
        switch mascotMood {
